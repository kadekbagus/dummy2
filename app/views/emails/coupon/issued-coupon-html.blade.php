...
<head>
    <title>Anda Mendapatkan Kupon!</title>
...
<body>
    <div>
        ...
        <![endif]--><div aria-labelledby="mj-column-per-100" class="mj-column-per-100" style="vertical-align:top;display:inline-block;font-size:13px;text-align:left;width:100%;"><table cellpadding="0" cellspacing="0" style="vertical-align:top;" width="100%" border="0"><tbody><tr><td style="word-break:break-word;font-size:0px;padding:0px;" align="center"><table cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0px;" align="center" border="0"><tbody><tr><td style="width:600px;"><img alt="Gotomalls Logo" title="" height="auto" src="{{ asset('emails/header-big-deals.jpg') }}" style="border:none;border-radius:;display:block;outline:none;text-decoration:none;width:100%;height:auto;" width="100%"></td></tr></tbody></table></td></tr></tbody></table></div><!--[if mso | IE]>
        </td></tr></table>
        ...
        <![endif]--><div aria-labelledby="mj-column-per-100" class="mj-column-per-100" style="vertical-align:top;display:inline-block;font-size:13px;text-align:left;width:100%;"><table cellpadding="0" cellspacing="0" width="100%" border="0"><tbody><tr><td style="word-break:break-word;font-size:0px;" align="center"><div><div class="mj-inline-links" style="width:100%;text-align:center;"><!--[if gte mso 9]>
            ...
            <![endif]--><a aria-labelledby="menu-column-per-33" class="menu-column-per-33" href="{{$base_url}}/?utm_source=gtm-activation-email&utm_medium=email&utm_content=menulink#!/malls" style="display:inline-block;text-decoration:none;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;font-weight:normal;line-height:22px;background: #BA1F00;padding: 5px 0px !important;width: 88px;margin: 0px 4px;border-radius: 16px;">Malls</a><!--[if gte mso 9]>
                </td>
            <![endif]--><!--[if gte mso 9]>
                <td style="padding: 15px 10px">
            <![endif]--><a aria-labelledby="menu-column-per-33" class="menu-column-per-33" href="{{$base_url}}/?utm_source=gtm-activation-email&utm_medium=email&utm_content=menulink#!/stores" style="display:inline-block;text-decoration:none;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;font-weight:normal;line-height:22px;background: #BA1F00;padding: 5px 0px !important;width: 88px;margin: 0px 4px;border-radius: 16px;">Stores</a><!--[if gte mso 9]>
                </td>
            <![endif]--><!--[if gte mso 9]>
                <td style="padding: 15px 10px">
            <![endif]--><a aria-labelledby="menu-column-per-33" class="menu-column-per-33" href="{{$base_url}}/?utm_source=gtm-activation-email&utm_medium=email&utm_content=menulink#!/promotions" style="display:inline-block;text-decoration:none;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;font-weight:normal;line-height:22px;background: #BA1F00;padding: 5px 0px !important;width: 88px;margin: 0px 4px;border-radius: 16px;">Promotions</a><!--[if gte mso 9]>
                </td>
            <![endif]--><!--[if gte mso 9]>
                <td style="padding: 15px 10px">
            <![endif]--><a aria-labelledby="menu-column-per-33" class="menu-column-per-33" href="{{$base_url}}/?utm_source=gtm-activation-email&utm_medium=email&utm_content=menulink#!/coupons" style="display:inline-block;text-decoration:none;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;font-weight:normal;line-height:22px;background: #BA1F00;padding: 5px 0px !important;width: 88px;margin: 0px 4px;border-radius: 16px;">Coupons</a><!--[if gte mso 9]>
                </td>
            <![endif]--><!--[if gte mso 9]>
                <td style="padding: 15px 10px">
            <![endif]--><a aria-labelledby="menu-column-per-33" class="menu-column-per-33" href="{{$base_url}}/?utm_source=gtm-activation-email&utm_medium=email&utm_content=menulink#!/luckydraws" style="display:inline-block;text-decoration:none;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;font-weight:normal;line-height:22px;background: #BA1F00;padding: 5px 0px !important;width: 88px;margin: 0px 4px;border-radius: 16px;">Lucky Draws</a><!--[if gte mso 9]>
                </td>
            <![endif]--><!--[if gte mso 9]>
                <td style="padding: 15px 10px">
            <![endif]--><a aria-labelledby="menu-column-per-33" class="menu-column-per-33" href="{{$base_url}}/?utm_source=gtm-activation-email&utm_medium=email&utm_content=menulink#!/events" style="display:inline-block;text-decoration:none;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;font-weight:normal;line-height:22px;background: #BA1F00;padding: 5px 0px !important;width: 88px;margin: 0px 4px;border-radius: 16px;">News</a><!--[if gte mso 9]>
                </td>
            <![endif]--><!--[if gte mso 9]>
                    </tr>
                </table>
        ...
        <![endif]--><div aria-labelledby="mj-column-per-100" class="mj-column-per-100" style="vertical-align:top;display:inline-block;font-size:13px;text-align:left;width:100%;"><table cellpadding="0" cellspacing="0" width="100%" border="0"><tbody><tr><td style="word-break:break-word;font-size:0px;padding:0 25px;" align="center"><div style="cursor:auto;color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;">
                    <h1 style="font-size: 1.6em;display:block">Kupon Anda:</h1>
                    <h1 style="font-size: 1.6em;display:block">{{{ $coupon_name }}}</h1>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="600" align="center" style="width:600px;">
            ...
            <![endif]--><div aria-labelledby="mj-column-per-100" class="mj-column-per-100" style="vertical-align:top;display:inline-block;font-size:13px;text-align:left;width:100%;"><table cellpadding="0" cellspacing="0" width="100%" border="0"><tbody><tr><td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="center"><div style="cursor:auto;color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;">
                <p align="center" style="margin:0">
                    Selamat Anda telah mendapatkan kupon dari Gotomalls.com.<br>Untuk menggunakan kupon, silahkan klik link &quot;Gunakan Kupon&quot; dibawah ini.
                </p>
              </div></td></tr><tr><td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="center"><table cellpadding="0" cellspacing="0" align="center" border="0"><tbody><tr><td style="border-radius:3px;color:white;cursor:auto;padding:10px 25px; border-radius: 16px;" align="center" valign="middle" bgcolor="#BA1F00"><a href="{{ $redeem_url }}" style="display:inline-block;text-decoration:none;background:#BA1F00;border-radius:3px;color:white;font-family:Helvetica;font-size:13px;font-weight:normal;margin:0px;">
                    Gunakan Kupon
        ...
        <![endif]--><div style="margin:0 auto;max-width:600px;"><table cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;" align="center" border="0"><tbody><tr><td style="text-align:center;vertical-align:top;font-size:0px;padding:0px;"><!--[if mso | IE]>
        <table border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;width:600px;">
        <![endif]--><div aria-labelledby="mj-column-per-100" class="mj-column-per-100" style="vertical-align:top;display:inline-block;font-size:13px;text-align:left;width:100%;"><table cellpadding="0" cellspacing="0" width="100%" border="0"><tbody><tr><td style="word-break:break-word;font-size:0px;padding:0 25px;" align="center">
        <img src="{{ asset('emails/email-footer.jpg') }}" />
