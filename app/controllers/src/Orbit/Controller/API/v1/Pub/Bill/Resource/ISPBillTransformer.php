...
trait ISPBillTransformer
{
    private function transformISPBillInformation($notes)
    {
        ...
        return empty($inquiry) ? null : [
            ...
            'total' => $inquiry->total,
            'receipt' => $this->parseISPBillReceipt(
                $inquiry->data->receipt->info
            ),
        ];
    }

    private function parseISPBillReceipt($receiptInfo)
    {
