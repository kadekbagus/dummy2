    ...
    <div class="header-location-banner">
        ...
        <div class="btn-group btn-group-justified" role="group">
            <div class="btn-group" role="group">
                <a type="button" class="btn btn-primary" href="{{ route('ci-coupon-list') }}">{{{ $page_sub_title['available_coupons'] }}}</a>
            </div>
            <div class="btn-group" role="group">
                <a type="button" class="btn btn-primary">{{{ $page_sub_title['coupon_wallet'] }}}</a>
            </div>
        </div>
            @else
