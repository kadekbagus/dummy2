...
<head>
  ...
  <title>Activation Email for Gotomalls.com</title>
...
<!--             <tr>
            ...
            <tr>
              <td align="center" valign="middle" style="box-shadow: 0 0 20px #e0e0e0; border-radius:5px;background-color: #FFF;">
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                  <tr>
                    <td width="300" class="mobile" align="left" valign="top">
                      <h3 class="greeting-username">{{ $greeting }}, {{ $first_name or $email }}</h3>
                  ...
                  <tr>
                    <td width="600" class="mobile" align="center" valign="middle">
                      <a href="{{ $token_url }}" class="btn-activate">{{ $button_activation }}</a>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="center"><hr class="separator" style="border: 0; height: 1px;background-color:#ddd;"></td>
                  </tr>
                  <tr>
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container marketing-container">
                  <tr>
                  ...
                  <tr>
                    <td valign="top" width="400" class="mobile full-width">
                      <address class="footer-address">
                        ...
                        <br>
                        <a href="tel:{{ $cs_phone }}" class="footer-telp">Telp. {{ $cs_phone }}</a>
                      </address>
                    </td>
