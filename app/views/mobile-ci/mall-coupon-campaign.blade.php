    ...
    <div class="col-xs-12 padded">
        ...
        <div class="row vertically-spaced">
            <div class="col-xs-12 text-center">
                <a href="{{{ \Orbit\Helper\Net\UrlChecker::blockedRoute('ci-tenant-list', ['coupon_id' => $coupon->promotion_id], $session) }}}" class="btn btn-info btn-block">{{{ Lang::get('mobileci.tenant.see_tenants') }}}</a>
            </div>
        </div>
        @endif
    </div>
