...
class UpdateCouponTest extends TestCase
{
    ...
    private function makeRequest($data, $authData = null)
    {
        ...
        $_POST = $data;
        $url = '/api/v1/coupon/update?' . http_build_query($_GET);
    ...
    public function testUpdateCoupon()
    {
        ...
        $this->assertCount(1, $coupon->tenants);
        $this->assertSame($coupon->merchant_id, $coupon->tenants[0]->merchant_id);
    }
