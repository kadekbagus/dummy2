                ...
                @foreach($data->records as $promo)
                    <div class="col-xs-12 col-sm-12 item-x" data-ids="{{$promo->news_id}}" id="item-{{$promo->news_id}}">
                        <section class="list-item-single-tenant">
                            <a class="list-item-link" data-href="{{ route('ci-promotion-detail', ['id' => $promo->news_id]) }}" href="{{ \Orbit\Helper\Net\UrlChecker::blockedRoute('ci-promotion-detail', ['id' => $promo->news_id], $session) }}">
