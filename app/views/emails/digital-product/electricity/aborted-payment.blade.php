                ...
                <tr>
                  <td width="300" class="mobile" align="left" valign="top">
                    <h3 class="greeting-username">
                      {{ trans(
                          'email-aborted-payment.body.greeting_digital_product.customer_name',
                ...
                <tr>
                  <td width="600" class="mobile" valign="middle">
                    <p class="transaction-details">
                      <strong>
                        {{{ trans(
                              'email-aborted-payment.body.transaction_labels.product_name',
                              [], '', $lang)
                        }}}
                      ...
                      <strong>
                        {{{ trans(
                              'email-aborted-payment.body.transaction_labels.transaction_id',
                              [], '', $lang)
                        }}}
                    ...
                    <p class="greeting-text">
                      {{ trans(
                          'email-aborted-payment.body.payment-info-line-2', $cs, '', 'id'
                      ) }}
                    </p>
                    ...
                    @if ('id' === 'en')
                      ...
                      <p class="greeting-text">
                        {{ trans('email-aborted-payment.body.payment-info-line-4-digital-product',
