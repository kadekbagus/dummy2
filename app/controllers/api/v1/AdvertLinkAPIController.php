        ...
        try {
            ...
            OrbitInput::get('placement', function($placement) use ($link)
            {
                if ($placement == 'top_banner') {
                    $link->whereIn('advert_type', array('no_link', 'information', 'url', 'store', 'promotion', 'coupon', 'mall'));
                } else if ($placement == 'footer_banner') {
                    $link->whereIn('advert_type', array('information', 'url', 'store', 'promotion', 'coupon', 'mall'));
