    ...
    public function getCRMSummaryReport()
    {
        try {
            ...
            $activities = DB::select(DB::raw("select dt.comp_date as date,
                                    ...
                                    IFNULL(MAX(CASE WHEN dt.label = 'Sign Up via Customer Service' THEN dt.count END), 0) AS 'sign_up_via_customer_service',
                                    ...
                                    IFNULL(MAX(CASE WHEN dt.label = 'Lucky Draw Number Issued' THEN dt.count END), 0) AS 'lucky_draw_number_issued',
                                    ...
                                    IFNULL(MAX(CASE WHEN dt.label = 'View Prizes & Winning Numbers' THEN dt.count END), 0) AS 'view_prizes_&_winning_numbers',
