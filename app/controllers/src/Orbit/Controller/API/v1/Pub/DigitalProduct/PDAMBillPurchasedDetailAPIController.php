...
class PDAMBillPurchasedDetailAPIController extends PubControllerAPI
{

    public function getPDAMBillPurchasedDetail()
    {
        $httpCode = 200;
        ...
        try {
            ...
            $pdamBill->payment_midtrans_info = json_decode(unserialize($pdamBill->payment_midtrans_info));
            $pdamBill->activation_code = unserialize($pdamBill->payload);

            $pdamBill->getRewards();

            $this->response->data = $pdamBill;
