...
return array(
    ...
    'activity_list' => array(
        ...
        '319' => array(
            'name' => 'click_instore_bp_detail_page',
            'name_long' => 'Click In Store Brand Product Detail Page',
            'module_name' => 'Brand Product',
            'type' => 'click',
            'object_type' => 'BrandProduct',
            'parameter_name' => 'object_id',
            'in_store_activity' => true,
        ),
        '320' => array(
            'name' => 'view_instore_bp_detail_page',
            'name_long' => 'View In Store Brand Product Detail Page',
            'module_name' => 'Brand Product',
            'type' => 'view',
            'object_type' => 'BrandProduct',
            'parameter_name' => 'object_id',
        ...
        '321' => array(
            'name' => 'click_instore_bp_add_to_cart_1',
            'name_long' => 'Click In Store Brand Product Add To Cart 1',
            'module_name' => 'Brand Product',
            'type' => 'click',
            'object_type' => 'BrandProduct',
            'parameter_name' => 'object_id',
        ...
        '322' => array(
            'name' => 'click_instore_bp_add_to_cart_2',
            'name_long' => 'Click In Store Brand Product Add To Cart 2',
            'module_name' => 'Brand Product',
            'type' => 'click',
            'object_type' => 'BrandProduct',
            'parameter_name' => 'object_id',
        ...
        '324' => array(
            'name' => 'view_instore_bp_list_page',
            'name_long' => 'View In Store Brand Product List Page',
            'module_name' => 'Brand Product',
            'type' => 'view',
            'object_type' => null,
            'parameter_name' => null,
        ...
        '325' => array(
            'name' => 'click_cart_menu',
            'name_long' => 'Click Cart Menu',
            'module_name' => 'Application',
            'type' => 'click',
            'object_type' => null,
            'parameter_name' => null,
        ...
        '326' => array(
            'name' => 'click_cart_reserve',
            'name_long' => 'Click Cart Reserve',
            'module_name' => 'Cart',
            'type' => 'click',
            'object_type' => 'BaseMerchant',
            'parameter_name' => 'object_id',
        ),
        '327' => array(
            'name' => 'click_cart_buy',
            'name_long' => 'Click Cart Buy',
            'module_name' => 'Cart',
            'type' => 'click',
            'object_type' => 'BaseMerchant',
            'parameter_name' => 'object_id',
