...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    <title>Retrying Pulsa Purchase</title>
          ...
          <tr>
            <td class="invoice-info" colspan="2" style="font-family:'Roboto', 'Arial', sans-serif;padding-top:20px;padding-bottom:20px;mso-table-lspace:0pt !important;mso-table-rspace:0pt !important;">
                ...
                <span style="font-size:24px;font-weight:bold;">
                    {{{ trans('email-coupon-not-available-admin.header.title_pulsa_retrying') }}}
                </span>
            </td>
          </tr>
          <tr>
            <td colspan="2" class="invoice-body" style="font-family:'Roboto', 'Arial', sans-serif;padding-top:10px;padding-bottom:80px;mso-table-lspace:0pt !important;mso-table-rspace:0pt !important;">
              <p style="font-family:'Roboto', 'Arial', sans-serif;margin:0;">
                {{ trans('email-coupon-not-available-admin.body.greeting_pulsa_retrying') }}
              </p>
              <br>
