...
use MallGroupAPIController;
use Setting;
use Response;

class MallGroupPrinterController extends DataPrinterController
{
    public function getMallGroupPrintView()
    {
        $this->preparePDO();
        ...
        $response = MallGroupAPIController::create('raw')
        ...
        switch ($mode) {
            case 'csv':
                ...
                printf("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n", '', 'Mall Group List', '', '', '', '', '','','','','');
                printf("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n", '', 'Total Mall Groups', $totalRec, '', '', '', '','','','','');

                printf("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n", '', '', '', '', '', '', '','','','','','');

                printf("%s,%s,%s,%s,%s,%s,%s,%s\n", '', 'Mall Group Name', 'Location', 'Start Date', 'End Date', 'Number of Malls', 'Malls', 'Status');
            ...
            default:
                $me = $this;
                require app_path() . '/views/printer/list-mallgroup-view.php';
        }
    }
