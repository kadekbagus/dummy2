...
class NewsLinkPreview implements ObjectLinkPreviewInterface
{
    ...
    public function getPreviewData()
    {
        ...
        if ($this->input['linkType'] === 'detail') {
            ...
            $title = isset($this->input['mallName']) ? sprintf(Lang::get('metatags.event_list.mall.title'), $this->input['mallName']) : Lang::get('metatags.event_list.gtm.title');
            $description = isset($this->input['mallName']) ? sprintf(Lang::get('metatags.event_list.mall.description'), $this->input['mallName']) : Lang::get('metatags.event_list.gtm.description');
            $url = $this->input['url'];
