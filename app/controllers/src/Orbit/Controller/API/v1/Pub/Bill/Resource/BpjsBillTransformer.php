...
trait BpjsBillTransformer
{
    private function transformBpjsBillInformation($notes)
    {
        ...
        return empty($inquiry) ? null : [
            ...
            'total' => $inquiry->total,
            'receipt' => $this->parseBpjsBillReceipt(
                $inquiry->data->receipt->info
            ),
        ];
    }

    private function parseBpjsBillReceipt($receiptInfo)
    {
