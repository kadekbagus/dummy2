...
<head>
  ...
  <title>{{ trans('email-order.complete-order.subject') }}</title>
                  ...
                  <table width="640" cellpadding="0" cellspacing="0" border="0" class="container mobile-full-width">
                    <tr>
                      <td align="center" valign="middle" height="184" class="greeting-title-container" style="border-radius: 5px 5px 0 0;">
                          <h1 class="greeting-title">{{ trans('email-order.complete-order.title', [], '', $lang) }}</h1>
                      </td>
                    </tr>
                  </table>
                  ...
                  <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                    <tr>
                      <td width="300" class="mobile" align="left" valign="top">
                        <h3 class="greeting-username">
                          {{ trans('email-order.complete-order.greeting', ['recipientName' => $recipientName], '', $lang) }}</h3>
                        <p class="greeting-text">
                        @if ($type === 'user')
                          {{ trans('email-order.complete-order.body.line-user', [], '', $lang) }}
                        @else
                          {{ trans('email-order.complete-order.body.line-admin', [], '', $lang) }}
                        @endif
                        </p>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td width="600" class="mobile reservation-actions" align="center" valign="middle">
                        ...
                        @if ($type === 'user')
                          {{{ trans('email-order.complete-order.btn_follow_up.user', [], '', $lang) }}}
                        @else
                          {{{ trans('email-order.complete-order.btn_follow_up.admin', [], '', $lang) }}}
                        @endif
                        </a>
                      </td>
                    </tr>
