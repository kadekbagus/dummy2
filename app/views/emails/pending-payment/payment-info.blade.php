              @if (! empty($paymentInfo) && isset($paymentInfo['bank_detail']))
                ...
                @endif
                  ...
                  <a href="{{{ $cancelUrl }}}" class="btn-cancel" style="font-family:'Roboto', 'Arial', sans-serif;border-radius:5px;border-width:1px;border-style:solid;border-color:#f43d3c;background-color:#fff;color:#f43d3c;font-weight:bold;font-size:16px;display:inline-block;padding:10px 0;text-decoration:none;width:30%;text-align:center;margin-top:10px;">
