                ...
                <tr>
                  <td class="greeting-text" style="font-family:'Roboto', 'Arial', sans-serif;padding-top:10px;padding-bottom:20px;mso-table-lspace:0pt !important;mso-table-rspace:0pt !important;">
                    ...
                    @if ($lang === 'id')
                      <p style="font-family:'Roboto', 'Arial', sans-serif;margin:0;">
                        <br>
                        {{ trans('email-canceled-payment.body.payment-info-line-1-data-plan', ['transactionDateTime' => $transactionDateTime], '', $lang) }}
                      </p>

                      <p style="font-family:'Roboto', 'Arial', sans-serif;margin:0;">
                        <br>
                        {{ trans('email-canceled-payment.body.payment-info-line-2-data-plan', $cs, '', $lang) }}
                      </p>
                    @elseif ($lang === 'en')
                      <p style="font-family:'Roboto', 'Arial', sans-serif;margin:0;">
                        <br>
                    ...
                    <p style="text-align: center">
                        ...
                        <a href="{{{ $buyUrl }}}" class="btn-redeem" style="font-family:'Roboto', 'Arial', sans-serif;border-radius:5px;background-color:#f43d3c;color:#fff;font-weight:bold;font-size:16px;display:inline-block;padding:10px 20px;text-decoration:none;">
                          {{{ trans('email-canceled-payment.body.buttons.buy_data_plan', [], '', $lang) }}}
                        </a>
                    </p>
