<?php
/**
 * Unit test for API MallAPIController::postNewMall
...
class postNewMallTest extends TestCase
{
    ...
    public function testCanCreateNewMall()
    {
    ...
    public function testAclMall()
    {
        ...
        $permission = Factory::create('Permission', ['permission_name' => 'create_mall']);
    ...
    public function testFieldsStored()
    {
        ...
        $db_mall = Mall::find($response->data->merchant_id);
        ...
        $this->assertSame((string)$this->country->country_id, (string)$db_mall->country_id);
        $this->assertSame($this->country->name, $db_mall->country);
