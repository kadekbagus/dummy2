...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    <title>Pulsa Success Without Serial Number</title>
        ...
        <thead>
          <tr class="invoice-header">
            ...
            <th class="text-right" style="font-family:'Roboto', 'Arial', sans-serif;text-align:right;padding-bottom:30px;">
              <span class="text-red invoice-title" style="color:#f43d3c;font-size:28px;font-weight:bold;">{{{ trans('email-pulsa-admin.header.type_pulsa_success_without_sn') }}}</span>
            </th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td colspan="2" class="invoice-info" style="font-family:'Roboto', 'Arial', sans-serif;padding-top:20px;padding-bottom:20px;mso-table-lspace:0pt !important;mso-table-rspace:0pt !important;">
                {{{ $transactionDateTime }}}
                <br>
                <span style="font-size:24px;font-weight:bold;">
                    {{{ trans('email-pulsa-admin.header.title_pulsa_success_without_sn') }}}
                </span>
            </td>
          </tr>
          <tr>
            <td colspan="2" class="invoice-body" style="font-family:'Roboto', 'Arial', sans-serif;padding-top:10px;padding-bottom:80px;mso-table-lspace:0pt !important;mso-table-rspace:0pt !important;">
              <p style="font-family:'Roboto', 'Arial', sans-serif;margin:0;">
                {{ trans('email-pulsa-admin.body.greeting_pulsa_success_without_sn') }}
              </p>
              <br>
              <table class="no-border customer" width="100%" style="line-height:1.7em;font-size:14px;color:#222;width:100%;border:0;margin-top:30px;border-spacing:0 !important;border-collapse:collapse !important;table-layout:fixed !important;margin:0 auto !important;mso-table-lspace:0pt !important;mso-table-rspace:0pt !important;">
                <thead>
                  <tr>
                    <th class="text-left first" width="25%" style="font-family:'Roboto', 'Arial', sans-serif;text-align:left;padding-left:15px;padding-left:0;">{{{ trans('email-pulsa-admin.table_customer_info.header.transaction_id') }}}</th>
                    <th class="text-left first" width="25%" style="font-family:'Roboto', 'Arial', sans-serif;text-align:left;padding-left:15px;padding-left:0;">{{{ trans('email-pulsa-admin.table_customer_info.header.customer') }}}</th>
                    <th class="text-left" width="25%" style="font-family:'Roboto', 'Arial', sans-serif;text-align:left;padding-left:15px;">{{{ trans('email-pulsa-admin.table_customer_info.header.email') }}}</th>
                    <th class="text-left" style="font-family:'Roboto', 'Arial', sans-serif;text-align:left;padding-left:15px;">{{{ trans('email-pulsa-admin.table_customer_info.header.phone') }}}</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
              ...
              <table class="no-border transaction" width="100%" style="line-height:1.7em;font-size:14px;color:#222;width:100%;border:0;margin-top:30px;border-spacing:0 !important;border-collapse:collapse !important;table-layout:fixed !important;margin:0 auto !important;mso-table-lspace:0pt !important;mso-table-rspace:0pt !important;">
                <thead class="bordered">
                  <tr>
                    <th class="text-left first" width="30%" style="font-family:'Roboto', 'Arial', sans-serif;text-align:left;padding:8px;border-top:1px solid #999;border-bottom:1px solid #999;padding-left:0;">{{{ trans('email-pulsa-admin.table_transaction.header.item') }}}</th>
                    <th class="text-left" width="20%" style="font-family:'Roboto', 'Arial', sans-serif;text-align:left;padding:8px;border-top:1px solid #999;border-bottom:1px solid #999;">{{{ trans('email-pulsa-admin.table_transaction.header.quantity') }}}</th>
                    <th class="text-left" width="25%" style="font-family:'Roboto', 'Arial', sans-serif;text-align:left;padding:8px;border-top:1px solid #999;border-bottom:1px solid #999;">{{{ trans('email-pulsa-admin.table_transaction.header.price') }}}</th>
                    <th class="text-left" width="25%" style="font-family:'Roboto', 'Arial', sans-serif;text-align:left;padding:8px;border-top:1px solid #999;border-bottom:1px solid #999;">{{{ trans('email-pulsa-admin.table_transaction.header.subtotal') }}}</th>
                  </tr>
                </thead>
                ...
                <tfoot class="transaction-footer">
                  <tr>
                    ...
                    <td style="font-family:'Roboto', 'Arial', sans-serif;padding:15px 8px;border-top:1px solid #999;mso-table-lspace:0pt !important;mso-table-rspace:0pt !important;"><strong>{{{ trans('email-pulsa-admin.table_transaction.footer.total') }}}</strong></td>
              ...
              <br>
              <p style="font-family:'Roboto', 'Arial', sans-serif;margin:0;">
                {{-- {{ trans('email-pulsa-admin.body.help', ['total' => $transaction['total']]) }} --}}
                <br>
                <br>
                {{{ trans('email-pulsa-admin.body.thank_you') }}}
              </p>
            </td>
          </tr>
        </tbody>
