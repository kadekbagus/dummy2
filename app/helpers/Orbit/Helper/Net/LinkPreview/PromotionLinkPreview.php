...
class PromotionLinkPreview implements ObjectLinkPreviewInterface
{
    protected $input;
    ...
    public function getPreviewData()
    {
        ...
        if ($this->input['linkType'] === 'detail') {
            ...
            $title = isset($this->input['mallName']) ? sprintf(Lang::get('metatags.promotion_list.mall.title'), $this->input['mallName']) : Lang::get('metatags.promotion_list.gtm.title');
            $description = isset($this->input['mallName']) ? sprintf(Lang::get('metatags.promotion_list.mall.description'), $this->input['mallName']) : Lang::get('metatags.promotion_list.gtm.description');
            $url = $this->input['url'];
