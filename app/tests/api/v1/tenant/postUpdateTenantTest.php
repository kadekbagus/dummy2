...
class postUpdateTenantTest extends OrbitTestCase
{
    /**
    ...
    public function testNoAuthData_POST_api_v1_tenant_update()
    {
        $url = '/api/v1/tenant/update';
    ...
    public function testInvalidSignature_POST_api_v1_tenant_update()
    {
    ...
    public function testAccessForbidden_POST_api_v1_tenant_update()
    {
        // Set the client API Keys
        $_GET['apikey'] = 'cde345';
        $_GET['apitimestamp'] = time();
        ...
        $updateRetailerLang = Lang::get('validation.orbit.actionlist.update_tenant');
    ...
    public function testMissingRetailerId_POST_api_v1_tenant_update()
    {
        // Set the client API Keys
        $_GET['apikey'] = 'cde345';
        $_GET['apitimestamp'] = time();
        ...
        $permission->permission_name = 'update_tenant';
        $permission->save();
    ...
    public function testRetailerIdNotExists_POST_api_v1_tenant_update()
    {
        // Data to be post
    ...
    public function testUserIdNotExists_POST_api_v1_tenant_update()
    {
        // Data to be post
    ...
    public function testInvalidEmailFormat_POST_api_v1_tenant_update()
    {
        // Data to be post
        $_POST['retailer_id'] = 10;
        $_POST['user_id'] = 3;
    ...
    public function testStatusNotExists_POST_api_v1_tenant_update()
    {
        // Data to be post
        $_POST['retailer_id'] = 10;
        $_POST['user_id'] = 3;
        ...
        $message = Lang::get('validation.orbit.empty.tenant_status');
        $data = new stdclass();
        $data->code = Status::INVALID_ARGUMENT;
        $data->status = 'error';
        $data->message = $message;
    ...
    public function testReqOK_POST_api_v1_retailer_update()
    {
        ...
        $this->assertSame('tenant', (string)$response->data->object_type);

        $numAfter = Tenant::count();
        $this->assertSame($numBefore, $numAfter);
    }

    public function testSavedThenRollback_POST_api_v1_tenant_update()
    {
        ...
        // does not commited
        Event::listen('orbit.tenant.postupdatetenant.after.save', function($controller, $retailer)
        {
        ...
        $retailer = Tenant::find(10);
        $this->assertSame('2', (string)$retailer->user_id);
        $this->assertSame('test@retailer.update', $retailer->email);
        $this->assertSame('test request ok: retailer update', $retailer->name);
        $this->assertSame('Parisian tea rooms', $retailer->description);
        $this->assertSame('pending', (string)$retailer->status);
        $this->assertSame('tenant', (string)$retailer->object_type);
