          ...
          <tr>
            <td colspan="2" class="invoice-body" style="font-family:'Roboto', 'Arial', sans-serif;padding-top:10px;padding-bottom:20px;mso-table-lspace:0pt !important;mso-table-rspace:0pt !important;">
              ...
              <p style="font-family:'Roboto', 'Arial', sans-serif;margin:0;">
                ...
                <br>
                <strong>{{{ trans('email-canceled-payment.body.transaction_labels.electricity_phone_number', [], '', 'id') }}}</strong> {{ $pulsaPhoneNumber }}
                <br>
                <br>
                <strong>{{{ trans('email-canceled-payment.body.transaction_labels.electricity_name', [], '', 'id') }}}</strong> {{ $transaction['items'][0]['name'] }}
                <br>
                <div style="width: 100%;">
                  <strong>{{{ trans('email-canceled-payment.body.transaction_labels.electricity_price', [], '', 'id') }}}</strong> {{ $transaction['items'][0]['price'] }}
                  &nbsp;&nbsp;&nbsp;
              ...
              <p style="font-family:'Roboto', 'Arial', sans-serif;margin:0;">
                <br>
                {{ trans('email-canceled-payment.body.payment-info-line-1-electricity', ['transactionDateTime' => $transactionDateTime], '', 'id') }}
              </p>

              <p style="font-family:'Roboto', 'Arial', sans-serif;margin:0;">
                <br>
                {{ trans('email-canceled-payment.body.payment-info-line-2-electricity', $cs, '', 'id') }}
              </p>
              ...
              <p style="text-align: center">
                  ...
                  <a href="{{{ $buyUrl }}}" class="btn-redeem" style="font-family:'Roboto', 'Arial', sans-serif;border-radius:5px;background-color:#f43d3c;color:#fff;font-weight:bold;font-size:16px;display:inline-block;padding:10px 20px;text-decoration:none;">
                    {{{ trans('email-canceled-payment.body.buttons.buy_electricity', [], '', 'id') }}}
                  </a>
              </p>
          ...
          <tr>
            <td colspan="2" class="invoice-body" style="font-family:'Roboto', 'Arial', sans-serif;padding-top:10px;padding-bottom:80px;mso-table-lspace:0pt !important;mso-table-rspace:0pt !important;">
              ...
              <p style="font-family:'Roboto', 'Arial', sans-serif;margin:0;">
                ...
                <br>
                <strong>{{{ trans('email-canceled-payment.body.transaction_labels.electricity_phone_number') }}}</strong> {{ $pulsaPhoneNumber }}
                <br>
                <br>
                <strong>{{{ trans('email-canceled-payment.body.transaction_labels.electricity_name') }}}</strong> {{ $transaction['items'][0]['name'] }}
                <br>
                <div style="width: 100%;">
                  <strong>{{{ trans('email-canceled-payment.body.transaction_labels.electricity_price') }}}</strong> {{ $transaction['items'][0]['price'] }}
                  &nbsp;&nbsp;&nbsp;
                  X {{ $transaction['items'][0]['quantity'] }}
                </div>
                @if (count($transaction['discounts']) > 0)
              ...
              <p style="text-align: center;">
                  <a href="{{{ $buyUrl }}}" class="btn-redeem" style="font-family:'Roboto', 'Arial', sans-serif;border-radius:5px;background-color:#f43d3c;color:#fff;font-weight:bold;font-size:16px;display:inline-block;padding:10px 20px;text-decoration:none;">
                    {{{ trans('email-canceled-payment.body.buttons.buy_electricity') }}}
                  </a>
              </p>
