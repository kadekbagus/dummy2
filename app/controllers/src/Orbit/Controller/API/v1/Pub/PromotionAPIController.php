...
class PromotionAPIController extends ControllerAPI
{
    ...
    public function getMallPerPromotion()
    {
        ...
        try{
            ...
            $urlToCI = URL::route('ci-promotion-detail', array(), false) . "?id=";
            $prefix = DB::getTablePrefix();
            $promotion = NewsMerchant::select('news.begin_date as begin_date', 'news.end_date as end_date',
                                            ...
                                            DB::raw("CONCAT(IF({$prefix}merchants.object_type = 'tenant', oms.ci_domain, {$prefix}merchants.ci_domain), '{$urlToCI}', {$prefix}news_merchant.news_id) as promotion_url"),
