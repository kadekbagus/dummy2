...
trait WaterBillTransformer
{
    private function transformWaterBillInformation($notes)
    {
        ...
        return empty($inquiry) ? null : [
            ...
            'total' => $inquiry->total,
            'receipt' => $this->parseWaterBillReceipt(
                $inquiry->data->receipt->info
            ),
        ];
    }

    private function parseWaterBillReceipt($receiptInfo)
    {
