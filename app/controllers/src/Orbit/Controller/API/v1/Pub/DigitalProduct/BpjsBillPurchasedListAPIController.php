...
class BpjsBillPurchasedListAPIController extends PubControllerAPI
{

    public function getBpjsBillPurchasedList()
    {
        $httpCode = 200;
        ...
        try {
            ...
            $bpjsBill = $bpjsBill->orderBy(DB::raw("{$prefix}payment_transactions.created_at"), 'desc');

            $_bpjsBill = clone $bpjsBill;
            ...
            $listbpjsBill = $bpjsBill->get();
            $count = RecordCounter::create($_bpjsBill)->count();

            $this->response->data = new stdClass();
            $this->response->data->total_records = $count;
            $this->response->data->returned_records = count($listbpjsBill);
            $this->response->data->records = $listbpjsBill;
