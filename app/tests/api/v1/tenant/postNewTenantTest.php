<?php
/**
 * Unit testing for TenantAPIController::postNewTenant() method.
 *
...
class postNewTenantTest extends OrbitTestCase
{
    ...
    public function tearDown()
    {
        ...
        // test
        $events = array(
            'orbit.tenant.postnewtenant.before.auth',
            'orbit.tenant.postnewtenant.after.auth',
            'orbit.tenant.postnewtenant.before.authz',
            'orbit.tenant.postnewtenant.authz.notallowed',
            'orbit.tenant.postnewtenant.after.authz',
            'orbit.tenant.postnewtenant.before.validation',
            'orbit.tenant.postnewtenant.after.validation',
            'orbit.tenant.postnewtenant.before.save',
            'orbit.tenant.postnewtenant.after.save',
            'orbit.tenant.postnewtenant.after.commit',
            'orbit.tenant.postnewtenant.access.forbidden',
            'orbit.tenant.postnewtenant.invalid.arguments',
            'orbit.tenant.postnewtenant.general.exception',
            'orbit.tenant.postnewtenant.before.render'
        );
    ...
    public function testNoAuthData_POST_api_v1_tenant_new()
    {
        $url = '/api/v1/tenant/new';
    ...
    public function testInvalidSignature_POST_api_v1_tenant_new()
    {
