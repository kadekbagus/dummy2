...
return [
    ...
    'body' => [
        ...
        'payment-info-line-1' => 'Please perform the payment transfer to the following bank account before <span style="color:">:paymentExpiration</span> to complete your transaction.',
