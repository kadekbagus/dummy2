...
class PulsaReportUserMonthlyAPIController extends ControllerAPI
{
	/**
     * Get monthly total transactions of a single user for the chart
     */
	public function get()
	{
		try {
					...
					left join
						(
							SELECT
								...
								DATE_FORMAT(pt.updated_at, '%Y-%m-01 00:00:00') AS view_date
							FROM
