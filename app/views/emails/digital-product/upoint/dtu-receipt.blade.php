                        ...
                        <td colspan="2" class="invoice-body" style="font-family:'Roboto', 'Arial', sans-serif;padding-top:10px;padding-bottom:10px;mso-table-lspace:0pt !important;mso-table-rspace:0pt !important;">
                          ...
                          <table class="no-border transaction" width="100%">
                            <thead class="bordered">
                              <tr>
                                <th class="transaction-item-name">
                                  {{{ trans('email-receipt.table_transaction.header.item', [], '', $lang) }}}
                                </th>
                                <th class="transaction-qty">
                                  {{{ trans('email-receipt.table_transaction.header.quantity', [], '', $lang) }}}
                                </th>
                                <th class="transaction-amount">
                                  {{{ trans('email-receipt.table_transaction.header.price', [], '', $lang) }}}
                                </th>
                                <th class="transaction-subtotal">
                                  {{{ trans('email-receipt.table_transaction.header.subtotal', [], '', $lang) }}}
                                </th>
                              </tr>
                            </thead>
                          ...
                          <p class="text-center" style="font-family:'Roboto', 'Arial', sans-serif;margin:0;text-align:center;">
                              <a href="{{{ $myWalletUrl }}}" class="btn btn-block">
