                ...
                <tr>
                  <td width="300" class="mobile" align="left" valign="top">
                    <h3 class="greeting-username">
                      {{ trans(
                          'email-expired-payment.body.greeting_digital_product.customer_name',
                          ['customerName' => $customerName], '', $lang
                        )
                      }}
                    </h3>
                    <p class="greeting-text">
                      {{ trans(
                          'email-expired-payment.body.greeting_digital_product.body',
                          [], '', $lang
                        )
                      }}
                    </p>
                ...
                <tr>
                  <td width="600" class="mobile" valign="middle">
                    <p class="transaction-details">
                      <strong>
                        {{{ trans(
                              'email-expired-payment.body.transaction_labels.product_name',
                              [], '', $lang
                            )
                        }}}
                      </strong>
                      ...
                      <strong>
                        {{{ trans(
                              'email-expired-payment.body.transaction_labels.transaction_id',
                              [], '', $lang
                            )
                        }}}
                      </strong>
                    ...
                    <p class="greeting-text">
                      <br>
                      {{ trans(
                          'email-expired-payment.body.payment-info-line-1',
                          ['transactionDateTime' => $transactionDateTime], '', $lang
                        )
                      }}
                    </p>
                    ...
                    @if ($lang === 'en')
                      ...
                      <p class="greeting-text">
                        {{ trans(
                              'email-expired-payment.body.payment-info-line-4-digital-product',
                ...
                <tr>
                  <td width="600" class="mobile" align="center" valign="middle">
                    <a href="{{{ $buyUrl }}}" class="btn btn-block">
                      {{{ trans(
                            'email-expired-payment.body.buttons.buy_digital_product',
                            ['productType' => $productType], '', $lang
                          )
                      }}}
                    </a>
