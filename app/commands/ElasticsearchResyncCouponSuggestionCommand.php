...
use Orbit\FakeJob;
use Orbit\Queue\Elasticsearch\ESCouponSuggestionUpdateQueue;

class ElasticsearchResyncCouponSuggestionCommand extends Command {
     ...
     * @var string
     */
    protected $name = 'elasticsearch:resync-coupon-suggestion';
    ...
    public function fire()
    {
        try {
            ...
            try {
                ...
                $this->info(sprintf('%sCoupon ID: "%s" has been successfully synced to Elasticsearch server (Coupon Suggestion Index)', $this->stdoutPrefix, $data['coupon_id']));
            } catch (Exception $e) {
    ...
    protected function syncData($job, $data)
    {
        ...
        $esQueue = new ESCouponSuggestionUpdateQueue();
