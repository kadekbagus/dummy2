<?php
/**
 * Unit testing for TenantAPIController::postDeleteTenant() method.
 *
...
class postDeleteTenantTest extends OrbitTestCase
{
    /**
    ...
    public function testNoAuthData_POST_api_v1_tenant_deleted()
    {
        $url = '/api/v1/tenant/delete';
    ...
    public function testInvalidSignature_POST_api_v1_tenant_delete()
    {
    ...
    public function testSignatureExpire_POST_api_v1_tenant_delete()
    {
        // Set the client API Keys
        $_GET['apikey'] = 'cde345';
    ...
    public function testAccessForbidden_POST_api_v1_tenant_delete()
    {
        // Set the client API Keys
        $_GET['apikey'] = 'cde345';
        $_GET['apitimestamp'] = time();
    ...
    public function testMissingRetailerId_POST_api_v1_tenant_delete()
    {
        // Set the client API Keys
        $_GET['apikey'] = 'cde345';
        $_GET['apitimestamp'] = time();
        ...
        $permission->permission_name = 'delete_tenant';
        $permission->save();
    ...
    public function testRetailerIdNotExists_POST_api_v1_tenant_delete()
    {
        // Data to be post
        ...
        $message = Lang::get('validation.orbit.empty.tenant');
        $data = new stdclass();
        $data->code = Status::INVALID_ARGUMENT;
        $data->status = 'error';
        $data->message = $message;
    ...
    public function testRetailerIdNotExists_StatusAlreadyDeleted_POST_api_v1_tenant_delete()
    {
        // Data to be post
        $_POST['retailer_id'] = '2';
    ...
    public function testMissingPassword_POST_api_v1_tenant_delete()
    {
        // Set the client API Keys
        $_GET['apikey'] = 'cde345';
        $_GET['apitimestamp'] = time();
    ...
    public function testWrongPasswordGiven_POST_api_v1_tenant_delete()
    {
        // Set the client API Keys
        $_GET['apikey'] = 'cde345';
        $_GET['apitimestamp'] = time();
    ...
    // public function testReqOK_POST_api_v1_tenant_delete()
    // {
    //     // Number of retailer not deleted before this operation
    //     $numBefore = Tenant::excludeDeleted()->count();

    //     // Data to be post
    //     $_POST['retailer_id'] = 4;     // Alfa Gwalk
    //     $_POST['password'] = '123';   // Chuck's password see setUpBeforeClass() for details

    //     // Set the client API Keys
    //     $_GET['apikey'] = 'cde345';
    //     $_GET['apitimestamp'] = time();

    //     $url = '/app/v1/tenant/delete?' . http_build_query($_GET);
    ...
    //     $expect->message = Lang::get('statuses.orbit.deleted.tenant');
    //     $expect->data = NULL;
    ...
    //     $this->assertSame('deleted', $tenant->status);

    //     $numAfter = Tenant::excludeDeleted()->count();
    //     $this->assertSame($numBefore - 1, $numAfter);
    // }

    // public function testSavedThenRollback_POST_api_v1_tenant_delete()
    // {
    ...
    //     // does not commited
    //     Event::listen('orbit.tenant.postdeletetenant.after.save', function($controller, $retailer)
    //     {
    ...
    //     // Data to be post
    //     $_POST['retailer_id'] = 4;  // Alfa Tunjungan
    //     $_POST['password'] = '123';
