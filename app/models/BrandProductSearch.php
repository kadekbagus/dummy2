...
/**
* Implementation of ES search for Brand...
*/
class BrandProductSearch extends CampaignSearch
{
    protected $objectType = 'brand_products';
    protected $objectTypeAlias = 'brand_product';
