...
class SeoTextAPIController extends ControllerAPI
{
    ...
    public function postNewSeoText()
    {
        ...
        try {
            ...
            $result = $this->validateAndSaveTranslations($country_id, $object_type, $translations, $status);
    ...
    private function validateAndSaveTranslations($country_id, $object_type, $translations, $status)
    {
