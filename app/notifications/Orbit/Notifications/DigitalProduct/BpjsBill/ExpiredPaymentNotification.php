...
{
    protected $signature = 'bpjs-bill-expired-transaction';

    public function getEmailTemplates()
    {
        return [
            'html' => 'emails.digital-product.bpjs-bill.expired-payment',
            'text' => 'emails.digital-product.bpjs-bill.expired-payment-text',
        ];
    }
}
