    ...
    <div class="slide-menu-container">
        <div class="slide-menu-middle-container">
            <ul class="slide-menu" role="menu">
                ...
                <li class=""><a href="{{ Config::get('orbit.shop.back_to_map_url') }}"><span><i class="fa fa-map fa-relative"></i> {{ ucwords(strtolower(Lang::get('mobileci.page_title.back_to_map'))) }}</span></a></li>
