                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                  ...
                  <tr>
                    <td width="600" class="mobile center" valign="middle" style="text-align: center;">
                      <a href="{{ $couponUrl }}" style="display: block;text-decoration: none;">
                        <span style="display: inline-block;border:1px solid #ddd;" class="coupon-image">
                  ...
                  <tr>
                    <td width="600" class="mobile" align="center" valign="middle">
                      <a href="{{ $acceptUrl }}" class="btn" style="padding-left: 30px; padding-right: 30px;">{{ $btnAccept }}</a>
                      &nbsp;
                      <a href="{{ $declineUrl }}" class="btn btn-light" style="padding-left: 30px; padding-right: 30px;">{{ $btnDecline }}</a>
                    </td>
                  </tr>
                  <tr>
                    <td height="30" align="center" class="separator">&nbsp;</td>
