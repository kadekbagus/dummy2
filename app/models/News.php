...
class News extends Eloquent
{
    ...
    public function campaignObjectPartners()
    {
        ...
        return $this->hasMany('ObjectPartner', 'object_id', 'news_id')
                      ->select('object_partner.object_id', DB::raw("{$prefix}partners.partner_id"), DB::raw("{$prefix}partners.partner_name"), DB::raw("{$prefix}partners.token"), DB::raw("{$prefix}partners.token"))
