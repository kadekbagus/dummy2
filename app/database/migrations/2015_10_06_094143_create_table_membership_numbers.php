...
class CreateTableMembershipNumbers extends Migration {
    ...
    public function up()
    {
        ...
        $builder->create('membership_numbers', function (OrbitBlueprint $table) {
            ...
            $table->string('membership_number_code', 50)->nullable();
            $table->datetime('expired_date')->nullable();
            $table->datetime('join_date')->nullable();
            $table->encodedId('issuer_retailer_id')->nullable();
            ...
            $table->index(array('membership_number_code'), 'membership_number_code_idx');
