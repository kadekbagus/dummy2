                ...
                @foreach($data->records as $news)
                    <div class="col-xs-12 col-sm-12 item-x" data-ids="{{$news->news_id}}" id="item-{{$news->news_id}}">
                        <section class="list-item-single-tenant">
                            <a class="list-item-link" data-href="{{ route('ci-news-detail', ['id' => $news->news_id]) }}" href="{{ \Orbit\Helper\Net\UrlChecker::blockedRoute('ci-news-detail', ['id' => $news->news_id], $session) }}">
