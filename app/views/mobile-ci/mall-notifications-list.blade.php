...
@section('content')
    <div id="delete-bar" class="row text-right">
        <div class="col-xs-10 text-delete-mode">
            <p>{{ Lang::get('mobile-ci.notification.delete_mode') }}</p>
        </div>
    ...
    <div class="col-xs-12 text-center vertically-spaced" style="display:none;" id="no-notification">{{ Lang::get('mobile-ci.notification.no_notif') }}</div>
    <div class="row">
        <button class="col-xs-offset-2 col-xs-8 btn btn-default loadmore">{{ Lang::get('mobile-ci.notification.load_more_btn') }}</button>
    </div>
