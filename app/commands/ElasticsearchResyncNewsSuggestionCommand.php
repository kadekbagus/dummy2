...
/**
 * Command for resync news data from MySQL to Elasticsearch based on news id
...
class ElasticsearchResyncNewsSuggestionCommand extends Command {
     ...
     * @var string
     */
    protected $name = 'elasticsearch:resync-news-suggestion';
    ...
    public function fire()
    {
        try {
            ...
            try {
                ...
                $this->info(sprintf('%sNews ID: "%s" has been successfully synced to Elasticsearch server (News Suggestion Index)', $this->stdoutPrefix, $data['news_id']));
            } catch (Exception $e) {
    ...
    protected function syncData($job, $data)
    {
        ...
        $esQueue = new ESNewsSuggestionUpdateQueue();
