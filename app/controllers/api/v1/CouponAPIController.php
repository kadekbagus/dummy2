...
*/
            ...
            // Push notification
            Event::fire('orbit.coupon.pushnotofication.after.commit', array($this, $newcoupon, $id_language_default));
...
*/
            ...
            // Push notification
            Event::fire('orbit.coupon.pushnotoficationupdate.after.commit', array($this, $updatedcoupon));
