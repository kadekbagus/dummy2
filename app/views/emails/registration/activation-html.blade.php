...
<div id="container;" style="padding:0; margin:0 auto;width:451px;border:1px solid #ccc">
    <div id="header" style="">
        <img style="width:451px;height:63" src="https://s3-ap-southeast-1.amazonaws.com/orbit-web/header-almost-in-orbit.png" alt="You are almost in Orbit!">
    </div>
    ...
    <div id="main" style="width:95%;margin: 0 auto;">
        ...
        and <strong style="font-size:18px;">money saving deals</strong>, follow the link below:</p>
        ...
        <img style="display:block;padding-top:0.7em" alt="Orbit Team" src="https://s3-ap-southeast-1.amazonaws.com/orbit-web/orbit-team.png">
        </p>
    </div>
