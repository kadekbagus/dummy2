...
{
    /** Allowed roles */
    protected $uploadRoles = ['merchant review admin', 'master review admin', 'consumer', 'merchant database admin', 'article writer', 'article publisher', 'product manager'];protected $uploadRoles = ['merchant review admin', 'master review admin', 'consumer', 'merchant database admin', 'article writer', 'article publisher', 'product manager'];
